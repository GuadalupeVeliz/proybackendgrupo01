...
dashboardRoutes.get("/reservas-por-mes", 
  /*
    #swagger.tags = ['Dashboard']
...
dashboardRoutes.get("/reservas-por-estado", 
  /*
    #swagger.tags = ['Dashboard']
...
dashboardRoutes.get("/ingresos-evolucion", 
  /*
    #swagger.tags = ['Dashboard']
...
dashboardRoutes.get('/exportar/pdf', 
  /*
    #swagger.tags = ['Dashboard']
...
dashboardRoutes.get('/exportar/excel', 
  /*
    #swagger.tags = ['Dashboard']
